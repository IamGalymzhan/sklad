...
export const INITIAL_STATE: DemoState = {
  ...
  units: [
    { id: "un-sht", name: "Дана", symbol: "дана", isActive: true },
    ...
    { id: "un-up", name: "Қаптама", symbol: "қап", isActive: true },
  ],

  warehouses: [
    { id: "wh-1", name: "Басты қойма", address: "Алматы, Қойма көшесі, 1", isActive: true },
    { id: "wh-2", name: "№ 2 қойма — Жеткізу бөлімі", address: "Алматы, Өндірістік көшесі, 5", isActive: true },
  ],
  ...
  receipts: [
    {
      ...
      comment: "Құрал-саймандар мен бекіткіштердің жоспарлы жеткізілімі",
      items: [
    ...
    },
    {
      ...
      comment: "Бекіткіштерді толықтыру",
      items: [
    ...
    },
    {
      ...
      comment: "Жоспарлы жеткізілім — растауды күтуде",
      items: [
  ...
  issues: [
    {
      ...
      date: "2026-05-16", recipientName: "Құрылыс бөлімі", status: "CONFIRMED",
    ...
    },
    {
      ...
      date: "2026-05-18", recipientName: "№ 3 өндірістік цех", status: "DRAFT",
